...
const EnhancedDashboard: React.FC<EnhancedDashboardProps> = ({
  ...
  const studentsArray = _students?.results || [];
  const teachersArray = _teachers?.results || [];
  const parentsArray = _parents?.results || [];
  ...
  const recentStudents = studentsArray
    .sort((a: any, b: any) => new Date(b.user?.date_joined || '').getTime() - new Date(a.user?.date_joined || '').getTime())
    .slice(0, 5);
  ...
  const menuItems = [
    ...
    { id: 'students', label: 'Students', icon: Users, count: totalStudents },
    { id: 'teachers', label: 'Teachers', icon: GraduationCap, count: totalTeachers },
    { id: 'parents', label: 'Parents', icon: Users, count: totalParents },
    { id: 'classrooms', label: 'Classrooms', icon: BookOpen, count: totalClasses },
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'dark bg-slate-950' : 'bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50'}`}>
      {/* Mobile Header */}
      <div className="lg:hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-40 shadow-sm">
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center gap-2">
            <button onClick={toggleTheme} className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-72 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 z-50 transform transition-transform duration-300 ease-in-out
          ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} 
          lg:translate-x-0 lg:sticky lg:top-0 lg:h-screen overflow-y-auto shadow-xl`}
      >
        {/* Logo */}
        <div className="p-6 border-b border-slate-200 dark:border-slate-700 hidden lg:block">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">SchoolMS</h1>
        ...
        <div className="p-4 border-b border-slate-200 dark:border-slate-700 lg:hidden">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-slate-900 dark:text-slate-100">{getUserDisplayName()}</h3>
        ...
        <div className="hidden lg:block p-4 border-t border-slate-200 dark:border-slate-700 mt-auto">
          <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-slate-900 dark:text-slate-100 text-sm">{getUserDisplayName()}</h3>
      ...
      <main className="lg:ml-72 min-h-screen">
        {/* Desktop Header */}
        <div className="hidden lg:block bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-30 shadow-sm">
            ...
            <div className="flex-1 max-w-2xl">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-slate-900 dark:text-slate-100"
                />
              </div>
            </div>
        ...
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-slate-600 dark:text-slate-400 mt-1">Here's what's happening in your school today</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            {/* Grade Distribution */}
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-lg transition-all duration-300">
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-4 flex items-center">
                <Award className="w-5 h-5 mr-2 text-blue-600" />
                Educational Level Distribution
              </h3>
          ...
          {/* Attendance Overview */}
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-lg transition-all duration-300 mb-8">
              ...
              <div className="space-y-2">
                ...
                {events.slice(0, 3).map(event => (
                  <div key={event.id} className="flex items-center space-x-2 p-2 bg-slate-50 dark:bg-slate-700 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-600 transition-colors">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    <span className="text-sm text-slate-900 dark:text-slate-100 flex-1">{event.title}</span>
                    <span className="text-xs text-slate-500 dark:text-slate-400">{event.date}</span>
                  </div>
                ))}
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-lg transition-all duration-300">
              <div className="p-5 sm:p-6 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 flex items-center">
                    <UserPlus className="w-5 h-5 mr-2 text-blue-600" />
                    Recent Students
              ...
              <div className="divide-y divide-slate-200 dark:divide-slate-700">
                {recentStudents.length > 0 ? (
                  recentStudents.map((student: any, idx: number) => (
                    <div key={idx} className="p-4 sm:p-5 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
            ...
            {/* Recent Teachers */}
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-lg transition-all duration-300">
              <div className="p-5 sm:p-6 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 flex items-center">
            ...
            {/* Recent Parents */}
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-lg transition-all duration-300">
              <div className="p-5 sm:p-6 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 flex items-center">
                    <UserCheck className="w-5 h-5 mr-2 text-purple-600" />
                    Recent Parents
