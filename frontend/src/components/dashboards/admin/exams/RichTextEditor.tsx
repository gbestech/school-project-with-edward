...
export default function App() {
  const [content, setContent] = useState("<p>Try the editor! Insert a table and test the buttons.</p>");

  const handleSubmit = () => {
    alert("Form submitted successfully! Content: " + content.substring(0, 50) + "...");
  };

  return (
    <div className="max-w-4xl mx-auto p-8">
      <h1 className="text-3xl font-bold mb-6">Fixed Rich Text Editor</h1>
      <div className="space-y-4">
        ...
        <div className="mt-4 p-4 bg-gray-100 rounded">
          <h2 className="font-bold mb-2">Demo Instructions:</h2>
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li>Insert a table using the "⊞ Table" button</li>
            <li>Click inside the table to activate table controls</li>
            <li>Add rows/columns - notice the form doesn't submit anymore!</li>
            <li>Click "◆ Shapes" to see the shape/symbol picker</li>
          </ul>
        </div>
      </div>
    </div>
