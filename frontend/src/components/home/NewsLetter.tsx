  ...
  return (
    <div className="bg-white dark:bg-slate-950 transition-colors duration-300">
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-50/30 via-white dark:from-slate-900/30 dark:via-slate-950 to-slate-50/30 dark:to-slate-900/30"></div>
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-100/20 dark:bg-blue-500/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-100/20 dark:bg-purple-500/10 rounded-full blur-3xl"></div>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="max-w-lg mx-auto">
            ...
            >
              ...
              <div className="relative bg-white dark:bg-slate-900 rounded-3xl p-3 shadow-2xl shadow-slate-200/50 dark:shadow-slate-900/50 border border-slate-200 dark:border-slate-700 hover:shadow-3xl hover:shadow-blue-500/10 dark:hover:shadow-blue-500/5 transition-all duration-500">
                <div className="flex items-center space-x-3">
                  <div className="flex-1 relative">
                    <input
                      ...
                      className="w-full px-6 py-4 bg-transparent text-slate-800 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none text-lg font-medium"
                    />
          ...
          <div className="mt-16 text-center">
            <p className="text-slate-500 dark:text-slate-400 text-sm mb-4">Join 50,000+ learners already transforming their careers</p>
            <div className="flex justify-center items-center space-x-2">
              ...
              <div className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-400 font-bold text-xs">
                +50K
              </div>
            </div>
          </div>
