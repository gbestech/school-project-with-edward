...
//                 <span   onClick={handleLoginClick} className="relative z-10 flex items-center space-x-2">
//                   <span>Sign In</span>
...
//               className="lg:hidden relative p-4 rounded-2xl hover:bg-white/10 text-white transition-all duration-300 group"
//             >
...
//       }`}>
//         <div className="bg-slate-900/95 backdrop-blur-3xl border-b border-slate-800/50 shadow-2xl">
...
//                 className="block text-slate-200/90 hover:text-white font-medium text-xl py-3 px-4 rounded-xl hover:bg-white/5 transition-all duration-300 transform hover:translate-x-2"
//                 style={{ 
...
//               <span onClick={handle} className="relative z-10">Sign In</span>
//             </button>
//           </div>
//         </div>
//       </div>
