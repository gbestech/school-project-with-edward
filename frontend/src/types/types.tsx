...
//   attendanceStatus: 'good' | 'average' | 'poor' | 'critical';
// }
...
//   attendanceRate: number;
//   lastAbsenceDate?: string;
//   attendanceStatus: 'excellent' | 'good' | 'average' | 'poor';
// }
...
//   parent_id: string;
//   occupation: string;
//   relationship_to_student: 'father' | 'mother' | 'guardian' | 'other';
//   children_ids: number[];
//   emergency_contact: string;
//   work_address: string;
...
// export type FullUserData = StudentUserData | TeacherUserData | ParentUserData;
...
//   sender?: string;
//   recipient?: string;
//   message_type?: 'notification' | 'announcement' | 'alert' | 'reminder';
